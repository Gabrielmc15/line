function stage3_load()
	...
	objects.platform_right.body = love.physics.newBody(world_3, width/2,(height*1/5)-19)
	...
	objects.ball = {}
	objects.ball.body = love.physics.newBody(world_3, width/2 ,(height*1/5)-47, "dynamic")

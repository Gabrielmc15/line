function stage6_load()
	...
	objects.platform_right.body = love.physics.newBody(world_6, width*1/4,(height*1/5)-19)
	...
	--------------------------------ball--------------------------------------------------
	objects.ball = {}
	objects.ball.body = love.physics.newBody(world_6, width/4 ,(height*1/5)-47, "dynamic")

...
function sideMenu_update(dt)
	if  not((passou and  fail) and  next_menu_active) then
		...
		if love.mouse.isDown(1) and stage_play then 
			if checarToqueCircle(x_mouse, y_mouse, x_stage_arrow_button+32 , y_stage_arrow_button +32, 32 ) and stage_arrow and (stage == 2 or stage == 4 or stage == 5 or stage == 7) then
				love.audio.play( click )
				if arrow_right_active then
					arrow_left_active = true
				...
				elseif checarToqueCircle(x_mouse, y_mouse, x_stage_ball_button+32 , y_stage_ball_button +32, 32 ) and stage_ball and (stage == 5 or stage == 7) then
					love.audio.play( click )
